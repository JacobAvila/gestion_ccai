...
<body>
                                        ...
                                        <div class="text-start">
                                            <ul class="list-group">
                                                <?php foreach($servicio_social as $est_ss){ 
                                                    $asp = $daoA->registroCorreo($est_ss->correo);
                                                    $area = "";
                                                    if($asp){
                                                        $area = $asp->area;
                                                    }
                                                ...
                                                <li class="list-group-item">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-title="Áea de interes" data-bs-content="<?php echo $area; ?>">
                                        ...
                                        <div class="text-start">
                                            <ul class="list-group">
                                                <?php foreach($residencias as $est_res){ 
                                                    $asp = $daoA->registroCorreo($est_res->correo);
                                                    $area = "";
                                                    if($asp){
                                                        $area = $asp->area;
                                                    }
    ...
    <?php
        $estud_ss =$daoEst->listadoPrograma("2024-1", "Servicio Social", "No Asignado", "Activo");
                    ...
                    ?>
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="<?php echo "ss_".$i; ?>">
                                    <div>
                                        <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="<?php echo $est_ss->id_estudiante." ".$area; ?>">
                                            <?php echo $est_ss->nombre; ?>
                                        </span>
                                    </div>
    ...
    <!--- Modal Residentes -->
    <?php
        $estud_rs =$daoEst->listadoPrograma("2024-1", "Residencias", "No Asignado", "Activo");
                    ...
                    ?>
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="<?php echo "res_".$i; ?>">
                                    <div>
                                        <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="<?php echo $est_res->id_estudiante." ".$area; ?>">    
                                            <?php echo $est_res->nombre; ?>
                                        </span>
                                    </div>
