...
<div class='nav animated bounceInDown bg-dark h-100 d-inline-block' >
	<ul>
		...
		<li><a href="<?php echo $home.'app/estudiantes/programa'; ?>"><?php echo $user->tipo; ?></a></li>
		<li class='sub-menu'><a href='#settings'>Proyecto<div class='fa fa-caret-down right'></div></a>
			<ul>
				<li><a href="<?php echo $home.'app/estudiantes/proyecto'; ?>">Plan de trabajo</a></li>
